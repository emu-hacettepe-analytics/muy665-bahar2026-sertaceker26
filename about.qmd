...
<div style="margin: 1rem 0;">
  ...
  <span class="skill-tag">Veri Görselleştirme</span>
</div>
```
...
<div style="display:flex; gap:.6rem; flex-wrap:wrap; margin-top:.5rem;">
  <span class="hero-badge">🤿 Serbest Dalış</span>
  <span class="hero-badge">⛷️ Kayak</span>
  <span class="hero-badge">🏊 Yüzme</span>
  <span class="hero-badge">✈️ Seyahat</span>
</div>
```
