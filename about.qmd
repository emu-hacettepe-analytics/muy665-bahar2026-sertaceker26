...
<div style="display:flex; align-items:center; gap:2rem; flex-wrap:wrap; margin-bottom:2rem;">
  ...
  <div>
    ...
    <p style="margin:.4rem 0 .8rem; color:#6b7280; font-size:1rem;">
      Üretim & Test Mühendisi · Mühendislik Yönetimi Yüksek Lisans Öğrencisi
    </p>
...
::: {style="margin: 1rem 0;"}
<strong style="color:#5b21b6; font-size:0.8rem; text-transform:uppercase; letter-spacing:.08em;"> Programlama & Analitik </strong><br><br> [R]{.skill-tag} [Quarto]{.skill-tag} [Git & GitHub]{.skill-tag} [Minitab]{.skill-tag}
:::

::: {style="margin: 1rem 0;"}
<strong style="color:#5b21b6; font-size:0.8rem; text-transform:uppercase; letter-spacing:.08em;"> Mühendislik Araçları </strong><br><br> [AutoCAD]{.skill-tag} [SAP]{.skill-tag} [Oracle]{.skill-tag} [Avix]{.skill-tag}
:::

::: {style="margin: 1rem 0;"}
<strong style="color:#5b21b6; font-size:0.8rem; text-transform:uppercase; letter-spacing:.08em;"> Metodoloji </strong><br><br> [Six Sigma (DMAIC)]{.skill-tag} [İstatistiksel Proses Kontrol]{.skill-tag} \<span class="
:::
