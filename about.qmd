...
::: {style="margin: 1rem 0;"}
<strong style="color:#5b21b6; font-size:0.8rem; text-transform:uppercase; letter-spacing:.08em;"> Metodoloji </strong><br><br> [Six Sigma (DMAIC)]{.skill-tag} [İstatistiksel Proses Kontrol]{.skill-tag}
:::
